...
document.addEventListener("DOMContentLoaded", (e) => {
        ...
        fetch(`/api/reviews/${id}`, {
            ...
            .then((data) => {
                if (data) {
                    ...
                    // Populate the form with the existing review
                    titleInput.value = data.title;
                    reviewInput.value = data.review;
                    ratingInput.value = data.rating;
                    authorInput.value = data.author;
                    reviewsSourceSelect.value = data.source;
    ...
    const reviewsSourceSelect = document.getElementById("source");

    // Set default value for the source
    reviewsSourceSelect.value = "Streaming";
    ...
    const handleFormSubmit = (e) => {
        ...
        const newReview = {
            ...
            source: reviewsSourceSelect.value,
        };
